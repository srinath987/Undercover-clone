...
const WORD_PAIRS = (() => {
  ...
  { civilian: 'Ice Cream', undercover: 'Popsicle' },
  { civilian: 'Chocolate', undercover: 'Candy' },
  { civilian: 'Apple', undercover: 'Pear' },
  { civilian: 'Bread', undercover: 'Bun' },
  ...
  { civilian: 'Crocodile', undercover: 'Swamp' },
  ...
  { civilian: 'Crab', undercover: 'Scorpion' },
  ...
  { civilian: 'Football', undercover: 'Goalpost' },
  ...
  { civilian: 'Billiards', undercover: 'Cue Stick' },
  ...
  { civilian: 'Router', undercover: 'Wi-Fi' },
  ...
  { civilian: 'Ocean', undercover: 'Coral Reef' },
  ...
  { civilian: 'Fog', undercover: 'Lighthouse' },
  ...
  { civilian: 'Sofa', undercover: 'Living Room' },
  { civilian: 'Pillow', undercover: 'Cushion' },
  { civilian: 'Lamp', undercover: 'Lantern' },
  { civilian: 'Scissors', undercover: 'Paper Cutter' },
  { civilian: 'Mug', undercover: 'Coaster' },
  ...
  { civilian: 'Glasses', undercover: 'Lens' },
  ...
  { civilian: 'Teacher', undercover: 'Blackboard' },
  ...
  { civilian: 'Barber', undercover: 'Razor' },
  { civilian: 'Florist', undercover: 'Gardener' },
  { civilian: 'Photographer', undercover: 'Tripod' },
  ...
  { civilian: 'Spy', undercover: 'Binoculars' },
  ...
  { civilian: 'Tea', undercover: 'Coffee' },
  { civilian: 'Roti', undercover: 'Rice' },
  { civilian: 'Idli', undercover: 'Vada' },
  { civilian: 'Samosa', undercover: 'Pakora' },
  { civilian: 'Dosa', undercover: 'Upma' },
  { civilian: 'Biryani', undercover: 'Noodles' },
  { civilian: 'Chutney', undercover: 'Pickle' },
  { civilian: 'Paneer', undercover: 'Egg' },
  { civilian: 'Biscuit', undercover: 'Namkeen' },
  { civilian: 'Juice', undercover: 'Lassi' },
  { civilian: 'Mango', undercover: 'Coconut' },
  { civilian: 'Potato', undercover: 'Onion' },
  { civilian: 'Lemon', undercover: 'Chilli' },
  { civilian: 'Milk', undercover: 'Curd' },
  { civilian: 'Dal', undercover: 'Sabzi' },
  { civilian: 'Spoon', undercover: 'Fork' },
  { civilian: 'Plate', undercover: 'Glass' },
  { civilian: 'Knife', undercover: 'Scissors' },
  { civilian: 'Bottle', undercover: 'Lunchbox' },
  { civilian: 'Bucket', undercover: 'Broom' },
  ...
  { civilian: 'Lock', undercover: 'Key' },
  { civilian: 'Fan', undercover: 'Bulb' },
  { civilian: 'Fridge', undercover: 'Washing Machine' },
  { civilian: 'Stove', undercover: 'Microwave' },
  { civilian: 'Tap', undercover: 'Shower' },
  { civilian: 'Soap', undercover: 'Towel' },
  { civilian: 'Shampoo', undercover: 'Comb' },
  { civilian: 'Toothbrush', undercover: 'Soap' },
  { civilian: 'Mirror', undercover: 'Comb' },
  { civilian: 'Curtain', undercover: 'Carpet' },
  { civilian: 'Balcony', undercover: 'Terrace' },
  { civilian: 'Shirt', undercover: 'Jeans' },
  { civilian: 'Kurta', undercover: 'Saree' },
  { civilian: 'Shoes', undercover: 'Socks' },
  { civilian: 'Belt', undercover: 'Wallet' },
  { civilian: 'Cap', undercover: 'Sunglasses' },
  { civilian: 'Ring', undercover: 'Necklace' },
  { civilian: 'Watch', undercover: 'Bracelet' },
  { civilian: 'Bag', undercover: 'Wallet' },
  { civilian: 'Umbrella', undercover: 'Raincoat' },
  { civilian: 'Bus', undercover: 'Train' },
  { civilian: 'Auto', undercover: 'Bus' },
  { civilian: 'Bike', undercover: 'Car' },
  { civilian: 'Metro', undercover: 'Auto' },
  { civilian: 'Cycle', undercover: 'Scooter' },
  { civilian: 'Road', undercover: 'Footpath' },
  { civilian: 'Bridge', undercover: 'Tunnel' },
  { civilian: 'Station', undercover: 'Airport' },
  { civilian: 'Ticket', undercover: 'Passport' },
  { civilian: 'Helmet', undercover: 'Seatbelt' },
  { civilian: 'Petrol', undercover: 'Diesel' },
  { civilian: 'School', undercover: 'Hospital' },
  { civilian: 'Teacher', undercover: 'Student' },
  { civilian: 'Pen', undercover: 'Eraser' },
  { civilian: 'Book', undercover: 'Pencil' },
  { civilian: 'Blackboard', undercover: 'Chalk' },
  { civilian: 'Classroom', undercover: 'Playground' },
  { civilian: 'Homework', undercover: 'Holiday' },
  { civilian: 'Principal', undercover: 'Student' },
  { civilian: 'Library', undercover: 'Playground' },
  { civilian: 'Doctor', undercover: 'Patient' },
  { civilian: 'Nurse', undercover: 'Medicine' },
  { civilian: 'Hospital', undercover: 'Ambulance' },
  { civilian: 'Tablet', undercover: 'Injection' },
  { civilian: 'Dentist', undercover: 'Toothbrush' },
  { civilian: 'Barber', undercover: 'Comb' },
  { civilian: 'Police', undercover: 'Thief' },
  { civilian: 'Judge', undercover: 'Lawyer' },
  { civilian: 'Driver', undercover: 'Passenger' },
  { civilian: 'Shopkeeper', undercover: 'Customer' },
  { civilian: 'Waiter', undercover: 'Customer' },
  { civilian: 'Farmer', undercover: 'Tractor' },
  { civilian: 'Tailor', undercover: 'Shirt' },
  { civilian: 'Electrician', undercover: 'Bulb' },
  { civilian: 'Plumber', undercover: 'Tap' },
  { civilian: 'Guard', undercover: 'Gate' },
  { civilian: 'Phone', undercover: 'Laptop' },
  { civilian: 'Keyboard', undercover: 'Mouse' },
  { civilian: 'Charger', undercover: 'Battery' },
  { civilian: 'Camera', undercover: 'Mobile' },
  { civilian: 'Wi-Fi', undercover: 'Bluetooth' },
  { civilian: 'WhatsApp', undercover: 'YouTube' },
  { civilian: 'Instagram', undercover: 'WhatsApp' },
  { civilian: 'Call', undercover: 'Message' },
  { civilian: 'Photo', undercover: 'Selfie' },
  { civilian: 'TV', undercover: 'Radio' },
  { civilian: 'Cricket', undercover: 'Badminton' },
  { civilian: 'Bat', undercover: 'Ball' },
  { civilian: 'Football', undercover: 'Goalpost' },
  { civilian: 'Cricket', undercover: 'Umpire' },
  { civilian: 'Stadium', undercover: 'Playground' },
  { civilian: 'Rain', undercover: 'Umbrella' },
  { civilian: 'Sun', undercover: 'Sunglasses' },
  { civilian: 'River', undercover: 'Boat' },
  { civilian: 'Temple', undercover: 'Bell' },
  { civilian: 'Wedding', undercover: 'Birthday' },
  { civilian: 'Pillow', undercover: 'Blanket' },
  { civilian: 'Balcony', undercover: 'Window' },
  { civilian: 'Curtain', undercover: 'Door' },
  { civilian: 'Mirror', undercover: 'Camera' },
  { civilian: 'Comb', undercover: 'Razor' },
  { civilian: 'Soap', undercover: 'Shampoo' },
  { civilian: 'Toothbrush', undercover: 'Mouthwash' },
  { civilian: 'Bucket', undercover: 'Shower' },
  { civilian: 'Towel', undercover: 'Handkerchief' },
  { civilian: 'Fridge', undercover: 'Microwave' },
  { civilian: 'Kettle', undercover: 'Thermos' },
  { civilian: 'Plate', undercover: 'Tiffin' },
  { civilian: 'Spoon', undercover: 'Fork' },
  { civilian: 'Bottle', undercover: 'Flask' },
  { civilian: 'Chutney', undercover: 'Pickle' },
  { civilian: 'Roti', undercover: 'Rice' },
  { civilian: 'Dosa', undercover: 'Paratha' },
  { civilian: 'Tea', undercover: 'Soup' },
  { civilian: 'Biscuit', undercover: 'Namkeen' },
  { civilian: 'Paneer', undercover: 'Egg' },
  { civilian: 'Helmet', undercover: 'Seatbelt' },
  { civilian: 'Platform', undercover: 'Bus Stop' },
  { civilian: 'Metro', undercover: 'Elevator' },
  { civilian: 'Ticket', undercover: 'Token' },
  { civilian: 'Petrol Pump', undercover: 'Parking' },
  { civilian: 'Auto', undercover: 'Scooter' },
  { civilian: 'Bridge', undercover: 'Tunnel' },
  { civilian: 'Footpath', undercover: 'Platform' },
  { civilian: 'School', undercover: 'Library' },
  { civilian: 'Blackboard', undercover: 'Notebook' },
  { civilian: 'Principal', undercover: 'Monitor' },
  { civilian: 'Homework', undercover: 'Exam' },
  { civilian: 'Pen', undercover: 'Chalk' },
  { civilian: 'Hospital', undercover: 'Pharmacy' },
  { civilian: 'Doctor', undercover: 'Pharmacist' },
  { civilian: 'Ambulance', undercover: 'Police Van' },
  { civilian: 'Tablet', undercover: 'Bandage' },
  { civilian: 'ATM', undercover: 'Bank' },
  { civilian: 'Wallet', undercover: 'Locker' },
  { civilian: 'Receipt', undercover: 'Ticket' },
  { civilian: 'Charger', undercover: 'Power Bank' },
  { civilian: 'Wi-Fi', undercover: 'Bluetooth' },
  { civilian: 'Screenshot', undercover: 'Photograph' },
  { civilian: 'Keyboard', undercover: 'Remote' },
  { civilian: 'Password', undercover: 'OTP' },
  { civilian: 'WhatsApp', undercover: 'Email' },
  { civilian: 'Stadium', undercover: 'Theatre' },
  { civilian: 'Umpire', undercover: 'Goalkeeper' },
  { civilian: 'Umbrella', undercover: 'Sunglasses' },
  { civilian: 'Wedding', undercover: 'Festival' },
  ].filter(({ civilian, undercover }) => {
    const normalizedCivilian = civilian.trim().toLocaleLowerCase();
    const normalizedUndercover = undercover.trim().toLocaleLowerCase();

    if (normalizedCivilian === normalizedUndercover) {
      return false;
    }

    const pairKey = `${normalizedCivilian}::${normalizedUndercover}`;
